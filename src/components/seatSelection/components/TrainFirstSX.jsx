...
const TrainFirstJSX = (props) => {
	return (
		<div className="mb-3 pb-5">
			...
			<img className="image-vagon-places" src={train_first_class} alt="..." />
			<div className="pl-4">
				<div className="train-first-container row ml-5 pl-5 mt-4">
