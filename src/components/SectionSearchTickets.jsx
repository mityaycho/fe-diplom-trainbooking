				...
				<div className="tickets-search-result col-lg-9 pt-5 pb-5 pl-5">
					...
					<div className="result-search-of-tickets row mt-4">
						<div className="select-tickets-search-number-train col-lg-3 pt-5 pb-5">
							...
							<p className="pl-3 pt-5 font-weight-light">Адлер<img className="pl-2" src={iconArrowRightGray} alt="..."/></p>
						...
						<div className="col-lg-9">
							...
							<div className="row justify-content-end">
								<button className="btn btn-warning btn-sm m-3 col-lg-3" to="/three_page" type="button">Выбрать места</button>
							</div>
						</div>
					</div>
					...
					<div className="row justify-content-end mt-5">
						<button className="page-search-select-number ml-3" to="/" type="button"><img src={iconSearchLeft} alt="иконка влево"/></button>
