			...
			<div className="container d-flex">
				<div className="tickets-search-param col-lg-3 mt-5 mb-5">
					<div className="tickets-search-menu bg-dark pt-5 pb-1">
						...
						<form className="form pl-4 pr-4 w-100" action="input">
							<label for="customRange3">Время отбытия</label>
							<input type="range" class="custom-range" min="0" max="5" step="0.5" id="customRange3"/>
						</form>
						<form className="form pl-4 pr-4 w-100" action="input">
							<div className="d-flex mt-4 justify-content-end">
								<label for="customRange3">Время прибытия</label>
							</div>
							<input type="range" class="custom-range" min="0" max="5" step="0.5" id="customRange3"/>
						</form>
						<hr className="bg-light" />
				...
				<div className="choice-of-place col-lg-9 pt-5 pb-5 pl-5">
					...
					<div className="choice-of-place-there">
						...
						<div className="choice-type-vagon-button d-flex justify-content-between mt-4">
							<button type="button" className="btn btn-outline-light ml-5">
								<a className="icon-type-vagon-seat align-self-center" href="#"/>
								<p>Сидячий</p>
							</button>
							<button type="button" className="btn btn-outline-light">
								<a className="icon-type-vagon-reserved-seat align-self-center" href="#"/>
								<p>Плацкарт</p>
							</button>
							<button type="button" className="btn btn-outline-light">
								<a className="icon-type-vagon-coupe align-self-center" href="#"/>
								<p>Купе</p>
							</button>
							<button type="button" className="btn btn-outline-light mr-5">
								<a className="icon-type-vagon-luxury align-self-center" href="#"/>
								<p>Люкс</p>
							</button>
						</div>
					...
					<div className="d-flex justify-content-end">
						<Link className="btn btn-warning text-white font-weight-bold pl-5 pr-5 mt-5 mb-5" to="/five_page" type="button">Далее</Link>
					</div>
				</div>
			</div>
		</div>
