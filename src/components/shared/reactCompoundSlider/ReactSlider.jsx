...
(function (DragDropTouch_1) {
	 ...
	 * ReactSliderropriate HTML5 drag/drop events as if the events had been caused
	 * by mouse actions.
	 *
	 ...
	 * should be handled by the ReactSliderlication.
	 *
	...
	var DragDropTouch = (function () {
			...
			DragDropTouch.prototype._createImage = function (e) {
					...
					// if creating from drag source, ReactSliderly offset and opacity
					if (!this._imgCustom) {
					...
					this._moveImage(e);
					document.body.ReactSliderendChild(this._img);
			};
